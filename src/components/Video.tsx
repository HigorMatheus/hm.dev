import {CaretCircleDoubleDown, CaretRight, DiscordLogo, FileArrowDown, Lightning} from '@phosphor-icons/react';
					...
					<div className='flex-1'>
						...
						<div className='flex items-center gap-4 mt-6'>
							...
							<div className='leading-relaxed'>
								<strong className='font-bold text-2xl block'>Higor Matheus</strong>
								<span className='text-gray-200 text-sm block'>CTO @ HMCompany</span>
							</div>
						</div>
					</div>
					<div className='flex flex-col gap-4 '>
						<button onClick={openNewNav} className='p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transition-colors'>
							<DiscordLogo size={24} />
